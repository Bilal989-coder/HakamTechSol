...
const service_data: DataType[] = [
  {
    id: 1,
    title: `Development`,
    des: `We specialize in building high-performance web and mobile applications tailored to your business needs. From startup MVPs to enterprise-level solutions, our expert developers turn ideas into scalable, secure, and user-friendly digital products.`
  },
  {
    id: 2,
    title: `Designing`,
    des: `Our creative team delivers visually stunning and highly functional designs that enhance user experience. Whether it’s UI/UX, branding, or complete product design, we blend aesthetics with usability to make your product stand out.`
  },
  {
    id: 3,
    title: `Marketing`,
    des: `We craft data-driven digital marketing strategies that help your brand grow and stand out online. From SEO and social media marketing to paid campaigns and content creation, our experts ensure maximum reach, engagement, and ROI for your business.`
  },
  {
    id: 4,
    title: `Resource OutSourcing`,
    des: `Scale your team quickly and cost-effectively with our reliable resource outsourcing services. We provide skilled developers, designers, and IT professionals who seamlessly integrate into your workflow and deliver results.`
  },
            ...
            {service_data.map((item, i) => (
              <div key={i} className="cs_card cs_style_1 cs_color_1 anim_div_ShowDowns">
                <div className="cs_card_left">
                  <div className="cs_card_number cs_primary_font" style={{ backgroundImage: `url(/assets/img/project_successfull_1.jpg)` }}>
                    0{i + 1}
                  </div>
                </div>

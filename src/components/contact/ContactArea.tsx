                ...
                <div className="col-md-4">
                  <div className="cs_icon">
                    ...
                    <div className="cs_icon_text">
                      ...
                      <p className="cs_icon_subtitle">LG-18, Kolachi IT Park, Rashid Minhas Road, Karachi, Pakistan</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="cs_icon">
                    ...
                    <div className="cs_icon_text">
                      ...
                      <p className="cs_icon_subtitle">+92 309 227 1214</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="cs_icon">
                    ...
                    <div className="cs_icon_text">
                      ...
                      <p className="cs_icon_subtitle">info@hakamtechsol.com</p>
                    </div>
                  </div>
                </div>
              </div>
